...
if __name__ == "__main__":
	...
	socket = networkhelper.gameconnect(config.ipaddress, config.port, "super")
	...
	isBalanced= True
	parse([matchupdb,request_rating,matchupdb,trans,request_leaderboard,],socket, dbcursor = conn, bms = bmstream, is_balanced = isBalanced)